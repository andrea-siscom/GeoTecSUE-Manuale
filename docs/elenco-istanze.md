...
3. **Gestione soggetti compilatori**: contiene il pulsante 👤 (*blu* oppure *verde*) per gestire i *soggetti compilatori* della pratica [vedi](nozioni-di-base#altri-soggetti-compilatori)
