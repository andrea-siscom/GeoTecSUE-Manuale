...
1. **Modifica**: contiene il pulsante ✏️ (*giallo*) per accedere alla pratica e proseguirne la compilazione [vedi](docs/interfaccia-e-convenzioni#modifica-pulsante-giallo)
2. 
