...
2. **Cancella**: contiene il pulsante 🗑️ (*rosso*) per eliminare la pratica. Prima dell'eliminazione definitiva, il sistema richiederà una *conferma* [vedi](interfaccia-e-convenzioni#elimina-pulsante-rosso)
