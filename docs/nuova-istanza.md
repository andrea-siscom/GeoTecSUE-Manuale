# 2. Creazione di una nuova istanza
...
All'avvio della pagina di **Duplica Istanza** il sistema propone le pratiche dell'ultimo anno. È possibile modificare questa ricerca andando a rimuovere quanto presente nel campo *Dalla data di registrazione*.

Cliccando il bottone **Nuova** il sistema avvia una nuova istanza con i campi comuni già precompilati.

### 2.2.1 È possibile duplicare un tipo pratica in una pratica di tipo differete?
...
### 2.2.2 Cosa non viene MAI duplicato
